...
#include "drmario.h" //just for VERSION ..
...
// handler.
// --------------------------------------------------------------------------
int RecordExceptionInfo (PEXCEPTION_POINTERS data, const char *Message, LPSTR lpCmdLine)
{
    ...
    FPrintf (fileHandle, "\r\n\r\n\r\n\r\n");
    FPrintf (fileHandle, "DrMario v%d.%d -ERROR LOG-\r\n\r\n", VERSION/100, VERSION%100);
